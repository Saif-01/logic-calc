...
#line 4 "parser.y" /* yacc.c:339  */
	...
	#include "parser.hpp"
	int yylex (void);
	int  yyparse(bool *result);
	void yyerror(bool *result, const char *msg);
...
{
  "$end", "error", "$undefined", "L_PAREN", "R_PAREN", "NEG", "AND", "OR",
  "IMP", "EQU", "VAR", "ERR", "CONSTANT", "$accept", "line", "exp", YY_NULLPTR
};
#endif
...
{
       6,     7,     8,     1,     9,     2,     0,     0,    14,    15,
      16,    17,     3,    13,     0,     9,    10,    11,    12,     9,
      10,    11,    12,     9,    10,    11
};

static const yytype_int8 yycheck[] =
{
       1,     2,     0,     3,     6,     5,    -1,    -1,     9,    10,
      11,    12,    12,     4,    -1,     6,     7,     8,     9,     6,
       7,     8,     9,     6,     7,     8
};
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, bool *result)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (result);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, bool *result)
{
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, bool *result)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, bool *result)
{
  YYUSE (yyvaluep);
  YYUSE (result);
  if (!yymsg)
